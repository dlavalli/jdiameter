...
public class SGdServerSessionImpl extends SGdSession implements ServerSGdSession, EventListener<Request, Answer>, NetworkReqListener {
  ...
  public SGdServerSessionImpl(IServerSGdSessionData sessionData,
                              ISGdMessageFactory fct,
                              ISessionFactory sf,
  ...
  // ServerSGdSession -------------------------------------------------------
  @Override
  public void sendMOForwardShortMessageAnswer(JMOForwardShortMessageAnswer answer)
      throws InternalException, IllegalDiameterStateException, RouteException, OverloadException {

  }

  @Override
  public void sendMTForwardShortMessageRequest(JMTForwardShortMessageRequest request)
      throws InternalException, IllegalDiameterStateException, RouteException, OverloadException {
