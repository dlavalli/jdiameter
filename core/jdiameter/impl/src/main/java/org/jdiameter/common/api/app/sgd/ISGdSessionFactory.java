...
/**
 * Session Factory interface for Diameter SGd application.
 *
 * @author <a href="mailto:lavalliere.daniel@gmail.com"> Alexandre Mendonca </a>
 */
public interface ISGdSessionFactory extends IAppSessionFactory {
   ...
   */
  void setServerSessionListener(ServerSGdSessionListener serverSessionListener);
   ...
   */
  void setClientSessionListener(ClientSGdSessionListener clientSessionListener);
