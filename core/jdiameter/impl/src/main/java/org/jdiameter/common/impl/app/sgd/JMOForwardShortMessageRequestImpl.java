 ...
 */
public class JMOForwardShortMessageRequestImpl extends AppRequestEventImpl implements JMOForwardShortMessageRequest {
   ...
   * @param message
   */
  public JMOForwardShortMessageRequestImpl(Message message) {
    super(message);
